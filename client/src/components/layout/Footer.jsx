...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      name: 'Instagram',
      url: 'https://www.instagram.com/fundacion_juan_xxiii',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'YouTube',
      url: 'https://www.youtube.com/channel/UC_fundacion_juan_xxiii',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/company/fundacion-juan-xxiii',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center sm:text-right">
              ...
              <div className="flex max-w-sm">
                <input
                  ...
                  className="flex-1 px-3 py-2 bg-primary-800 text-white rounded-l-lg border border-primary-700 focus:outline-none focus:border-secondary-500 text-sm"
                />
                <button className="px-4 py-2 bg-secondary-600 text-white rounded-r-lg hover:bg-secondary-700 transition-colors text-sm">
                  Suscribirse
                </button>
              </div>
            </div>
